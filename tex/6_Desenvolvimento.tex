...
\figura{figuras/grafico-correcao}{Gráfico de evolução do \sintonia\ (percentual de gordura): a linha ``medido'' oscila conforme o contexto de cada medição, enquanto a linha ``corrigido'' permanece estável; a faixa sombreada é o intervalo de confiança de 95\% da correção}{fig:grafico-correcao}{width=\linewidth}
