\begin{itemize}
    ...
    \item Embora o sistema use um SLM especializado para gerar as interpretações, não foram
    realizadas nesta etapa técnicas de \emph{fine-tuning} supervisionado ou treinamento do
    modelo com bases próprias. A especialização foi feita por regras de interpretação,
    engenharia de \emph{prompt} e integração com modelos biométricos da literatura.
