...
\emph{Small Language Model} (SLM) executado localmente e orientado por engenharia de
\emph{prompt} atenderia melhor. O modelo adotado foi o Qwen 2.5 (7B), que interpreta as métricas de
