...
\begin{itemize}
    ...
    \item Adotar uma linha de base adaptativa para a correção \emph{within-user}, sensível ao
    tempo (por exemplo, uma janela móvel de medições ou um modelo que separe a tendência real
    da composição corporal do viés dos fatores de contexto), para que mudanças reais do corpo
    ao longo de semanas e meses não sejam confundidas com o ruído das medições.
